...
if(!isset($_SERVER['HTTP_REFERER'])){
	echo("<script>alert(\"YOUR NOT SUPPOSED TO BE HERE!\"); window.location = \"../products.php\"</script>");
//	header("Location: ../index.php");
}
require("DBHandler/DBController.php");
$db = new DBController();
$results = array();
$results = $db->getProduct(substr($_SERVER["QUERY_STRING"], strrpos($_SERVER["QUERY_STRING"], '=' )+1));
	echo "<p>" . $results[0]['id__'] . "</p><br>";
echo "<p>" . $results[0]['name'] . "</p><br>";
echo "<p>" . $results[0]['price'] . "</p><br>";
echo "<p>" . $results[0]['stock'] . "</p><br>";
echo "<p>" . $results[0]['color'] . "</p><br>";
echo "<p>" . $results[0]['size'] . "</p><br>";
echo "<p>" . $results[0]['gender'] . "</p><br>";
echo "<p>" . $results[0]['category'] . "</p><br>";
echo "<p>" . $results[0]['imagePath'] . "</p><br>";


$sizes = array();
$sizes = $db->getProductSizes($results[0]['name']);
$looper = 0; 
echo("<select>");
while($looper < count($sizes)){
	echo "<option value = 1> " . $sizes[$looper]['size'] . "</option>";
	$looper++;
}
echo("</select>");
?>
