...
<?php include("Headers/generalHeader.php")?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8">
						...
						<table class="table table-striped">
							...
							<tbody>
								<tr>
									...
									<td><a href="product_detail.php"><img alt="" src="themes/images/woman/top8.jpg"></a></td>
								...
								<tr>
									<td><input type="checkbox" value="option1"></td>
									<td><a href="product_detail.php"><img alt="" src="themes/images/woman/top5.jpg"></a></td>
								...
								<tr>
									<td><input type="checkbox" value="option1"></td>
									<td><a href="product_detail.php"><img alt="" src="themes/images/woman/top7.jpg"></a></td>
